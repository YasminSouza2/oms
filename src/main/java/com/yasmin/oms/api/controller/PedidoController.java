...
public class PedidoController {
    ...
    public ResponseEntity<PedidoResponse> criar(
        ...
        if (principal != null && request.getUsuarioId() == null) {
    ...
    @PostMapping("/{id}/finalizar-pagamento")
    public ResponseEntity<PedidoResponse> finalizarPagamento(@PathVariable UUID id) {
        return ResponseEntity.ok(pedidoService.finalizarPagamento(id));
    }
}
